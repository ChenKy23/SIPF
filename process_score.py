...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_pred_pth", default='/home/chenkaiyuan/SIPF/dataset/sample_iter0_gemma-2b_gemma_mbpp_write.json', help="dataset_test's path")
    ...
    parser.add_argument('--log_file', type=str, default='/home/chenkaiyuan/dpo_math/sft_verifier_mks.log')
    parser.add_argument('--output_model_path', type=str, default='/home/chenkaiyuan/dpo_math/model')
    ...
    parser.add_argument("--model_checkpoint", default='/home/chenkaiyuan/SIPF/model/deepseek-coder-6.7b-instruct_mbpp_verifier_gemma-epoch-6', help="model checkpoint's path")
